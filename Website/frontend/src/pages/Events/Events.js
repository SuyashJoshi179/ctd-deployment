...
const Events = () => {
  const dataNCC = {
    ...
    contacts: [
      { name: "Atharva Naphade", contact: "94237 54562" },
      { name: "Atharva Kulkarni", contact: "98604 29679" },
    ],
  };
  const dataNTH = {
    ...
    contacts: [
      { name: "Siddharth Bora", contact: "94033 04652" },
      { name: "Suyash More", contact: "95950 55056" },
    ],
  };
  const dataQuiz = {
    ...
    contacts: [
      { name: "Avantika Patil", contact: "85306 34832" },
      { name: "Rohit James", contact: "81388 55702" },
    ],
  };
  const dataRC = {
    ...
    contacts: [
      { name: "Atharva Naphade", contact: "94237 54562" },
      { name: "Neil Deshpande", contact: "88056 00298" },
    ],
  };
